        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="{{url('public')}}/images/gambar1.png" alt="Image" class="img-fluid">
            </a>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="block-5 mb-5">
              ...
              <ul class="list-unstyled">
                <li class="address">Jl.Dalong Rangga< Sentap</li>
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            ...
            Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart" aria-hidden="true"></i> by <a href="https://www.instagram.com/khafifahrahayu_20/" target="_blank" class="text-primary">Khafifah Rahayu</a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
          </div>
